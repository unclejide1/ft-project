package com.fintech.demo.security;


import com.fintech.demo.security.jwt.JwtAuthenticationEntryPoint;
import com.fintech.demo.security.jwt.JwtAuthenticationFilter;
import com.fintech.demo.security.services.MyUserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/card-scheme/**").permitAll()
